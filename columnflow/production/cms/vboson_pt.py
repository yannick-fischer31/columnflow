...
"""
Producers for vector boson pt reweighting.
"""
...
def gen_v_boson(self: Producer, events: ak.Array, **kwargs) -> ak.Array:
    ...
    Creates new collection named "GenVBoson"

    *produced_v_columns* can be adapted to change the columns that will be produced
    for the GenVBoson collection.
    """
