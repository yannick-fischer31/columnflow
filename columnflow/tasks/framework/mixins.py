...
class SelectorStepsMixin(SelectorMixin, ConfigTask):
...
class MLModelTrainingMixin(
    ...
    def resolve_param_values(cls, params: dict[str, Any]) -> dict[str, Any]:
        ...
        if "ml_model_inst" in params:
            ...
            params["calibrators"] = ml_model_inst.training_calibrators(analysis_inst, params["calibrators"])
            params["selector"] = ml_model_inst.training_selector(analysis_inst, params["selector"])
            params["producers"] = ml_model_inst.training_producers(analysis_inst, params["producers"])
